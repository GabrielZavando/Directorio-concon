...
export class HealthController {
  ...
  @ApiOperation({
    ...
    description: 'Endpoint para verificar que la API está funcionando correctamente y el estado de los servicios conectados'
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiResponse({
    status: 503,
    description: 'Servicio no disponible - Uno o más servicios no están funcionando correctamente'
  })
  getHealth() {
