...
export class CreateEmpresaDto {
  ...
  @ApiProperty({
    ...
    example: "Restaurante familiar especializado en mariscos.",
  })
  @IsString()
  @MinLength(10)
  @MaxLength(1000)
  ...
  @ApiProperty({
    ...
    example: "Av. Borgoño 12345, Concón",
  })
  @IsString()
  @MaxLength(200)
  direccion: string;
  ...
  @ApiPropertyOptional({
    description: "Phone (Chilean format)",
    example: "+56932123456",
  })
  @IsOptional()
  @IsString()
  ...
  @ApiPropertyOptional({
    description: "Social networks (max 3)",
    type: [RedSocialDto],
  })
  @IsOptional()
  @IsArray()
  ...
  @ApiPropertyOptional({
    description: "Image gallery (premium only)",
  ...
  @ApiPropertyOptional({
    description: "Promotional video URL (premium)",
  ...
  @ApiPropertyOptional({
    description: "Slogan or tagline (premium)",
  ...
  @ApiPropertyOptional({
    description: "Mission statement (premium)",
    example: "Ofrecer la mejor experiencia gastronómica",
  })
  @IsOptional()
  @IsString()
  @MaxLength(500)
  ...
  @ApiPropertyOptional({
    description: "Vision statement (premium)",
    example: "Ser el restaurante más reconocido de la región",
  })
  @IsOptional()
  @IsString()
  @MaxLength(500)
  ...
  @ApiPropertyOptional({
    description: "Corporate values (premium)",
    example: ["Calidad", "Frescura"],
  })
  @IsOptional()
  @IsArray()
  @IsString({ each: true })
  ...
  @ApiPropertyOptional({
    description: "Featured specialties (premium)",
    example: ["Paella marinera", "Ceviche"],
  })
  @IsOptional()
  @IsArray()
  @IsString({ each: true })
  ...
  @ApiPropertyOptional({
    description: "Certifications (premium)",
  ...
  @ApiPropertyOptional({
    description: "Team members (premium)",
  ...
  @ApiPropertyOptional({
    description: "Chat enabled for networking (premium)",
    example: true,
    default: false,
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: "SEO keywords (premium)",
    example: ["restaurante", "mariscos", "concón"],
  })
  @IsOptional()
  @IsArray()
  @IsString({ each: true })
  ...
  @ApiPropertyOptional({
    description: "Custom meta description for SEO (premium)",
    example: "Restaurante El Marino en Concón",
  })
  @IsOptional()
  @IsString()
  @MaxLength(160)
