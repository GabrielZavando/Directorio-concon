...
export class RedSocialDto {
  ...
  @IsString()
  @Matches(/^[a-z-]+$/, { message: 'El icono debe estar en formato kebab-case' })
  icono: string;
  ...
  @IsOptional()
  @Matches(/^#[0-9A-F]{6}$/i, { message: 'Debe ser un color hexadecimal válido' })
  color?: string;
}
...
export class ImagenGaleriaDto {
  ...
  @ApiProperty({
    ...
    example: 'https://storage.googleapis.com/directorio-concon/empresas/logo.jpg'
  })
  @IsUrl()
  url: string;
...
export class MiembroEquipoDto {
  ...
  @IsString()
  @MaxLength(100)
  @Matches(/^[a-zA-ZáéíóúÁÉÍÓÚñÑ\s\-\.]+$/, { message: 'Solo letras, espacios y guiones' })
  nombre: string;
...
export class CreateEmpresaDto {
  ...
  @ApiProperty({
    ...
    example: 'Restaurante familiar especializado en mariscos y pescados frescos de la zona.'
  })
  @IsString()
  @MinLength(10)
  @MaxLength(1000)
  ...
  @ApiPropertyOptional({
    ...
    example: 'Ofrecer la mejor experiencia gastronómica con productos frescos del mar'
  })
  @IsOptional()
  @IsString()
  @MaxLength(500)
  ...
  @ApiPropertyOptional({
    ...
    example: 'Restaurante El Marino en Concón - Los mejores mariscos y pescados frescos'
  })
  @IsOptional()
  @IsString()
  @MaxLength(160)
