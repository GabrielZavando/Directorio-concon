...
export class AppController {
  ...
  @ApiOperation({ 
    ...
    description: 'Endpoint raíz que retorna información básica sobre la API del Directorio de Concón'
  })
  @ApiResponse({
    status: 200,
    ...
    schema: {
      type: 'object',
      properties: {
        message: { type: 'string', example: 'API del Directorio de Empresas de Concón' },
